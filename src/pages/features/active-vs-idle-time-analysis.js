...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"features/active-vs-idle-time-analysis"} />
		<Helmet>
			<title>
			...
			<Stack margin="0px 0px 0px 0px">
				...
				>
					...
					<Box display="flex" align-items="center">
						...
						/>
						<Text margin="9px 0px 9px 18px" color="#555" font="400 18px/160% --fontFamily-googleInter" sm-font="400 16px/22px --fontFamily-googleInter">
							Identify laggards in your organization{"\n\n"}
						</Text>
					</Box>
					{"    "}
					<Link
		...
		<Section background="#FFFFFF" padding="24px 0 24px 0">
			...
			<Stack margin="0px 0px 0px 0px" width="100%" gap="--cmp-stack-gap-default">
				...
				<StackItem display="flex" sm-width="100%" md-width="100%" width="80%">
					<Override slot="StackItemContent" flex-direction="column" />
					<Box display="flex" margin="0px 0px 18 0px">
						<Image src="https://uploads.quarkly.io/5f844e532e3a2a001faf55b8/images/211.png?v=2021-02-04T05:11:18.893Z" srcSet="https://smartuploads.quarkly.io/5f844e532e3a2a001faf55b8/images/211.png?v=2021-02-04T05%3A11%3A18.893Z&quality=85&w=500 500w,https://smartuploads.quarkly.io/5f844e532e3a2a001faf55b8/images/211.png?v=2021-02-04T05%3A11%3A18.893Z&quality=85&w=800 800w,https://smartuploads.quarkly.io/5f844e532e3a2a001faf55b8/images/211.png?v=2021-02-04T05%3A11%3A18.893Z&quality=85&w=1080 1080w,https://smartuploads.quarkly.io/5f844e532e3a2a001faf55b8/images/211.png?v=2021-02-04T05%3A11%3A18.893Z&quality=85&w=1600 1600w,https://smartuploads.quarkly.io/5f844e532e3a2a001faf55b8/images/211.png?v=2021-02-04T05%3A11%3A18.893Z&quality=85&w=2000 2000w,https://smartuploads.quarkly.io/5f844e532e3a2a001faf55b8/images/211.png?v=2021-02-04T05%3A11%3A18.893Z&quality=85&w=2600 2600w,https://smartuploads.quarkly.io/5f844e532e3a2a001faf55b8/images/211.png?v=2021-02-04T05%3A11%3A18.893Z&quality=85&w=3200 3200w" sizes="(max-width: 576px) 100vw,(max-width: 768px) 100vw,(max-width: 992px) 100vw,(max-width: 1066px) 100vw,(max-width: 1560px) 100vw,100vw" />
					</Box>
					{"            "}
				</StackItem>
				{"    "}
