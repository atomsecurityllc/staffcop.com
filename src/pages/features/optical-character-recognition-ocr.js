...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"features/optical-character-recognition-ocr"} />
		<Helmet>
			<title>
