...
import { Theme, Text, Link, Section, Hr, Icon, Box, Strong, Span, Image } from "@quarkly/widgets";
	...
	return <Theme theme={theme}>
		...
		<Section sm-padding="80px 0 18px 0" padding="103px 0 18px 0">
			...
			<Stack margin="0px 0px 0px 0px">
				{"    "}
				<StackItem sm-align-items="center" sm-width="100%" width="100%" display="flex">
					<Override
			...
			<Stack margin="0px 0px 0px 0px" width="100%">
				...
				>
					<Override
						...
						flex-direction="column"
					/>
					<Box md-flex-direction="column" display="flex">
						<Box
							md-width="100%"
							width="33.33333%"
							display="flex"
						...
						>
							<Text color="rgba(19, 33, 42, 1)" font="normal 600 24px/31px --fontFamily-googleInter" padding="36px 24px 36px 36px" margin="0px 0px 0px 0px">
								Data Inventory
								<br />
								<br />
								<br />
			...
			<Stack width="100%" margin="0px 0px 0px 0px">
				...
				<StackItem md-width="100%" width="33.3333%" display="flex" lg-width="50%">
					...
					<Box
						...
						background="#FFFFFF"
					>
						<Image height="60px" width="60px" src="https://uploads.quarkly.io/5f844e532e3a2a001faf55b8/images/zamolk.svg?v=2020-10-19T23:25:24.891Z" />
						<Text
							font="normal 700 24px/140% --fontFamily-googleInter"
							margin="30px 0px 18px 0px"
							display="inline-block"
				...
				<StackItem lg-width="100%" md-width="100%" width="33.3333%" display="flex">
					<Override
						slot="StackItemContent"
						border-image="linear-gradient(353.68deg, rgba(255, 255, 255, 0) -0.12%, rgba(255, 255, 255, 0.04) 56.34%)  3 / 1 / 0 stretch"
						flex-direction="column"
