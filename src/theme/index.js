export default {
	...
	"font": {
		...
		"headline2": "normal 700 48px/58px --fontFamily-googleInter",
		"headline3": "normal 600 24px/140% --fontFamily-googleInter",
		"base": "normal 300 16px/1.5 --fontFamily-sans",
		"lead": "normal 300 18px/160% --fontFamily-googleInter",
		"menu": "500 18px/22px --fontFamily-googleInter"
	},
	"boxShadow": {
